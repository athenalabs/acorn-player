...
$.widget("ui.rangeslider", $.ui.mouse, {
  ...
  _mouseCapture: function(event) {
    var position, normValue, distance, closestHandle, index, allowed, offset,
        mouseOverHandle, values, reverseOrdered, that = this, o = this.options;
  ...
  _normValueFromMouse: function(position) {
    ...
    if (this.orientation === "horizontal") {
      ...
      pixelMouse =
          ...
          (this.handles.outerWidth() / 2) -
          (this._clickOffset ? this._clickOffset.left : 0);

    } else {
      pixelTotal = this.element.outerHeight() - this.handles.outerHeight();
      pixelMouse =
          position.y -
          this.elementOffset.top -
          (this.handles.outerHeight() / 2) -
  ...
  _refreshValues: function() {
    var o, animation, indexLower, indexHigher, indices, position, dimension,
        borderWidth, rangeScalar, pos = {}, dim = {}, i, index, handle,
        valPercent, lastValPercent, that = this;
