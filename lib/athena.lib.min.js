...
test.describeView=function(b,a,c,d){null==c&&(c={});return describe(""+b.name+" view tests",function(){it("should be a function",function(){return expect(typeof b).toBe("function")});it("should derive from "+a.name,function(){return expect(athena.lib.util.derives(b,a)).toBe(!0)});it("should be constructible with given options",function(){var a;expect(function(){return new b(c)}).not.toThrow();a=new b(c);expect(a instanceof b).toBe(!0);return expect(a.options).toBe(c)});it("should have a defaults function, that returns an object",
function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(c);return expect(typeof a.defaults()).toBe("object")});it("should have an events function, that returns an object",function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(c);return expect(typeof a.events()).toBe("object")});it("should have render return @",function(){var a;a=new b(c);return expect(a.render()).toBe(a)});return"function"===typeof d?d():void 0})};
...
function(a){return b.$el.addClass(a)})};a.prototype.destroy=function(){this.rendering=!1;this.remove();this.unbind();return this.uninitialize()};a.prototype.rendering=!1;a.prototype.render=function(){a.__super__.render.call(this);this.rendering=!0;this.delegateEvents();return this};a.prototype.softRender=function(){if(this.rendering)return this.render()};a.prototype.uninitialize=function(){};return a}(Backbone.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function c(){this.constructor=b}for(var d in a)__hasProp.call(a,d)&&(b[d]=a[d]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b};
...
return this};return a}(athena.lib.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function c(){this.constructor=b}for(var d in a)__hasProp.call(a,d)&&(b[d]=a[d]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b};
athena.lib.ToolbarView=function(b){function a(){this.buttonFromObject=__bind(this.buttonFromObject,this);this.renderButton=__bind(this.renderButton,this);this.render=__bind(this.render,this);this.initialize=__bind(this.initialize,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.className="toolbar-view";a.prototype.initialize=function(){var b;a.__super__.initialize.apply(this,arguments);return this.buttons=null!=(b=this.options.buttons)?b:[]};a.prototype.render=
...
b.addClass(a.className);a.id&&b.attr("id",a.id);_.each(null!=(e=a.events)?e:{},function(a,c){return b.on(c,a)});return b};return a}(athena.lib.View);("undefined"!==typeof exports&&null!==exports?exports:this).athena=athena;}).call(this);
