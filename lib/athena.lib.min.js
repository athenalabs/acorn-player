...
test.describeProperty=function(b,a,d,c,e){null==d&&(d={});null==c&&(c={});null==c.setter&&(c.setter=!0);return describe(""+b.name+"::"+a,function(){it("should be a function",function(){return expect(typeof b.prototype[a]).toBe("function")});it("should get the value of the attribute",function(){var e,g;e=new b(d);expect(e[a]()).toEqual((g=c["default"])!=null?g:e.get(a));e.set(a,"foo");expect(e[a]()).toEqual(e.get(a));return expect(e[a]()).toEqual("foo")});c.setter===false?it("should NOT set the value of the attribute (setter is false)",
function(){var e,g,h,i;e=new b(d);expect(e[a]()).toEqual((g=c["default"])!=null?g:e.get(a));expect(e[a]()).not.toEqual("foo");expect(e[a]("foo")).toEqual((h=c["default"])!=null?h:e.get(a));expect(e[a]()).toEqual((i=c["default"])!=null?i:e.get(a));return expect(e[a]()).not.toEqual("foo")}):it("should set the value of the attribute",function(){var e,g;e=new b(d);expect(e[a]()).not.toEqual("foo");expect(e[a]()).toEqual((g=c["default"])!=null?g:e.get(a));expect(e[a]("foo")).toEqual(e.get(a));return expect(e[a]()).toEqual("foo")});
it("should use default value "+c["default"],function(){var e;e=new b(d);c["default"]!=null&&expect(e.get(a)).not.toEqual(c["default"]);return e.get(a)?expect(e[a]()).toEqual(e.get(a)):d[a]!=null&&d[a]!==c["default"]?expect(e[a]()).not.toEqual(c["default"]):expect(e[a]()).toEqual(c["default"])});return typeof e==="function"?e():void 0})};
...
!1;this.remove();this.unbind();return this.uninitialize()};a.prototype.rendering=!1;a.prototype.render=function(){var b=this;a.__super__.render.apply(this,arguments);this.rendering=!0;this.delegateEvents();_.each(this.elAttributes(),function(a,e){if(b.$el.attr(e)!==a)return b.$el.attr(e,a)});return this};a.prototype.softRender=function(){if(this.rendering)return this.render()};a.prototype.uninitialize=function(){};return a}(Backbone.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
...
athena.lib.GridView=function(b){function a(){this.removeTileForModel=__bind(this.removeTileForModel,this);this.renderTileForModel=__bind(this.renderTileForModel,this);this.render=__bind(this.render,this);this.initialize=__bind(this.initialize,this);this.defaults=__bind(this.defaults,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.tagName="ul";a.prototype.className=a.classNameExtend("grid-view thumbnails");a.prototype.defaults=function(){return _.extend(a.__super__.defaults.apply(this,
arguments),{tileOptions:{}})};a.prototype.initialize=function(){var b=this;a.__super__.initialize.apply(this,arguments);this.tileViews=[];this.listenTo(this.collection,"add",function(a){if(b.rendering)return b.renderTileForModel(a)});this.listenTo(this.collection,"remove",function(a){if(b.rendering)return b.removeTileForModel(a)});return this.listenTo(this.collection,"reset",function(){return b.softRender()})};a.prototype.render=function(){a.__super__.render.apply(this,arguments);_.each(this.tileViews,
function(a){return a.destroy()});this.$el.empty();this.collection.each(this.renderTileForModel);return this};a.prototype.renderTileForModel=function(a){a=new athena.lib.GridTileView(_.extend({},this.options.tileOptions,{eventhub:this.eventhub,model:a}));a.on("all",_.bind(this.trigger,this));this.tileViews.push(a);this.$el.append(a.render().el);return this};a.prototype.removeTileForModel=function(a){var b;if(b=_.find(this.tileViews,function(b){return b.model===a}))return this.tileViews.pop(b),b.$el.parent().remove(),
b.destroy(),this};return a}(athena.lib.View);
athena.lib.GridTileView=function(b){function a(){this.render=__bind(this.render,this);this.defaults=__bind(this.defaults,this);this.events=__bind(this.events,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.tagName="li";a.prototype.className=a.classNameExtend("grid-tile-view thumbnail");a.prototype.template=_.template('<a href="<%= link %>">\n  <img src="<%= thumbnail %>" />\n</a>');a.prototype.events=function(){var b=this;return _.extend(a.__super__.events.apply(this,
arguments),{"click a":function(a){b.trigger("GridTile:Click",b);if(!b.options.tileVars(b.model).link)return a.preventDefault(),!1}})};a.prototype.defaults=function(){return _.extend(a.__super__.defaults.apply(this,arguments),{tileVars:function(a){return{link:"function"===typeof a.get?a.get("link"):void 0,thumbnail:"function"===typeof a.get?a.get("thumbnail"):void 0}}})};a.prototype.render=function(){var b;a.__super__.render.apply(this,arguments);this.$el.empty();b=this.options.tileVars(this.model);
_.defaults(b,{link:"#",thumbnail:""});this.$el.html(this.template(b));return this};return a}(athena.lib.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
...
this.$(".modal-footer").append(this.toolbarView.render().el);this.$el.modal({show:this.options.show,keyboard:!1,backdrop:"static"});return this};a.prototype._toolbarButtons=function(){return[{text:this.options.closeButtonName,className:"dismiss-modal"}]};a.prototype.show=function(){return this.$el.modal("show")};a.prototype.hide=function(){return this.$el.modal("hide")};a.prototype._onShowEvent=function(){this.trigger("show");return this._onShow()};a.prototype._onShownEvent=function(){this._onShown();
...
athena.lib.FormModalView=function(b){function a(){this._onGlobalKeyupEnter=__bind(this._onGlobalKeyupEnter,this);this._onClickSubmit=__bind(this._onClickSubmit,this);this._submit=__bind(this._submit,this);this.clear=__bind(this.clear,this);this.values=__bind(this.values,this);this._toolbarButtons=__bind(this._toolbarButtons,this);this.render=__bind(this.render,this);this._initializeFormView=__bind(this._initializeFormView,this);this.initialize=__bind(this.initialize,this);this.events=__bind(this.events,
this);this.defaults=__bind(this.defaults,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.className=a.classNameExtend("form-modal-view");a.prototype.defaults=function(){return _.extend(a.__super__.defaults.apply(this,arguments),{title:"Form",closeButtonName:"Cancel",submitButtonName:"Submit"})};a.prototype.events=function(){return _.extend(a.__super__.events.apply(this,arguments),{"click .submit":this._onClickSubmit})};a.prototype.initialize=function(){a.__super__.initialize.apply(this,
...
this.options).onSubmit)b.onSubmit(a,this);return this.trigger("FormModalView:Submit",a,this)};a.prototype._onClickSubmit=function(){return this._submit()};a.prototype._onGlobalKeyupEnter=function(){};return a}(athena.lib.ModalView);("undefined"!==typeof exports&&null!==exports?exports:this).athena=athena;}).call(this);
