...
a.navigate(this.pathname,{trigger:!0});return!1})};return a}(Backbone.Router);athena.lib.util={};
...
test.throwsExceptionWithString=function(b,a,c){var d;d=!1;null!=c?c instanceof Array||(c=[c]):c=[];try{a.apply(null,c)}catch(e){d=0<=e.message.search(b)}return d};
test.describeProperty=function(b,a,c,d,e){null==c&&(c={});null==d&&(d={});null==d.setter&&(d.setter=!0);return describe(""+b.name+"::"+a,function(){it("should be a function",function(){return expect(typeof b.prototype[a]).toBe("function")});it("should get the value of the attribute",function(){var e,g;e=new b(c);expect(e[a]()).toEqual((g=d["default"])!=null?g:e.get(a));e.set(a,"foo");expect(e[a]()).toEqual(e.get(a));return expect(e[a]()).toEqual("foo")});d.setter===false?it("should NOT set the value of the attribute (setter is false)",
function(){var e,g,h,i;e=new b(c);expect(e[a]()).toEqual((g=d["default"])!=null?g:e.get(a));expect(e[a]()).not.toEqual("foo");expect(e[a]("foo")).toEqual((h=d["default"])!=null?h:e.get(a));expect(e[a]()).toEqual((i=d["default"])!=null?i:e.get(a));return expect(e[a]()).not.toEqual("foo")}):it("should set the value of the attribute",function(){var e,g;e=new b(c);expect(e[a]()).not.toEqual("foo");expect(e[a]()).toEqual((g=d["default"])!=null?g:e.get(a));expect(e[a]("foo")).toEqual(e.get(a));return expect(e[a]()).toEqual("foo")});
it("should use default value "+d["default"],function(){var e;e=new b(c);d["default"]!=null&&expect(e.get(a)).not.toEqual(d["default"]);return e.get(a)?expect(e[a]()).toEqual(e.get(a)):c[a]!=null&&c[a]!==d["default"]?expect(e[a]()).not.toEqual(d["default"]):expect(e[a]()).toEqual(d["default"])});return typeof e==="function"?e():void 0})};
...
it("should have a className property of type string",function(){return expect(typeof b.prototype.className).toBe("string")});it("should have a defaults function, that returns an object",function(){var a;expect(typeof b.prototype.defaults).toBe("function");a=new b(c);return expect(typeof a.defaults()).toBe("object")});it("should have an events function, that returns an object",function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(c);return expect(typeof a.events()).toBe("object")});
it("should have an elAttributes function, that returns an object",function(){var a;expect(typeof b.prototype.elAttributes).toBe("function");a=new b(c);return expect(typeof a.elAttributes()).toBe("object")});it("should set @eventhub in initialize (i.e. should call super)",function(){var a,d;a=new athena.lib.View;d=_.defaults({eventhub:a},c);d=new b(d);return expect(d.eventhub).toBe(a)});it("should have render return @",function(){var a;a=new b(c);return expect(a.render()).toBe(a)});it("should be rendering after render (i.e. should call super)",
function(){var a;a=new b(c);expect(a.rendering).toBe(false);a.render();return expect(a.rendering).toBe(true)});return typeof d==="function"?d():void 0})};test.describeDefaults=function(b,a,c){null==c&&(c={});return describe(""+b.name+"::defaults",function(){var d;d=(new b(c)).defaults();return _.each(a,function(a,c){return it("should have options."+c+" default to "+JSON.stringify(a),function(){return expect(d[c]).toEqual(a)})})})};
test.describeSubview=function(b,a){var c,d,e,f,g;d=b.View;g=b.viewOptions;f=b.subviewAttr;c=b.Subview;e=b.checkDOM;null==e&&(e=function(a,c){return a.parentNode===c});return describe(""+d.name+"::"+f+" subview",function(){it("should be defined on init",function(){var a;a=new d(g);return expect(a[f]).toBeDefined()});it("should be an instanceof "+c.name,function(){var a;a=new d(g);return expect(a[f]instanceof c).toBe(!0)});it("should not be rendering initially",function(){var a;a=new d(g);return expect(a[f].rendering).toBe(!1)});
it("should be rendering with "+d.name,function(){var a;a=new d(g);a.render();return expect(a[f].rendering).toBe(!0)});it("should share eventhub with "+d.name,function(){var a;a=new d(g);a.render();return expect(a[f].eventhub).toBe(a.eventhub)});it("should be a DOM child of the "+d.name,function(){var a;a=new d(g);a.render();return expect(e(a[f].el,a.el)).toBe(!0)});return"function"===typeof a?a():void 0})};
test.describeFormComponent=function(b,a){var c,d;c=b.View;d=b.name;return describe(""+c.name+"::"+d,function(){it("should be a FormComponentView",function(){var a;a=new c;return expect(a[d]instanceof athena.lib.FormComponentView).toBe(!0)});athena.lib.util.derives(c,athena.lib.FormView)&&(it("should be added to "+c.name+"::componentViews",function(){var a;a=new c;return expect(_.contains(a.componentViews,a[d])).toBe(!0)}),it("should share the eventhub with "+c.name,function(){var a;a=new c;return expect(a[d].eventhub).toBe(a.eventhub)}));
_.each("id type label placeholder helpBlock helpInline".split(" "),function(a){if(b[a])return it("should have "+a+": "+b[a],function(){var f;f=new c;return expect(f[d].options[a]).toBe(b[a])})});return"function"===typeof a?a():void 0})};
test.EventSpy=function(){function b(a,c){this.target=a;this.eventName=c;this.callsSinceLastCheck=__bind(this.callsSinceLastCheck,this);this.trigger=__bind(this.trigger,this);this.reset=__bind(this.reset,this);this.reset();this.target.on(null!=c?c:"all",this.trigger)}b.prototype.reset=function(){this.triggered=!1;this._callsSinceLastCheck=this.triggerCount=0;return this.arguments=[]};b.prototype.trigger=function(){this.triggered=!0;this.triggerCount++;this._callsSinceLastCheck++;return this.arguments.push(_.toArray(arguments))};
b.prototype.callsSinceLastCheck=function(){var a;a=this._callsSinceLastCheck;this._callsSinceLastCheck=0;return a};return b}();test.expectEventSpyBehaviors=function(b,a){var c,d,e,f,g,h,i,j,l,m,k;k=[];j=0;for(l=a.length;j<l;j++)g=a[j],e=null!=(m=g())?m:{},k.push(function(){var a;a=[];for(i in b)h=b[i],f=e.hasOwnProperty(i),d=h.callsSinceLastCheck(),expect(!!d).toBe(f),f&&null!=(c=e[i])?(_.isArray(c)||(c=[c]),a.push(expect(_.last(h.arguments)).toEqual(c))):a.push(void 0);return a}());return k};
test.xit=function(b,a,c){null==c&&(c="---- TODO");b=""+c+": "+b;console.log(b);return it(b,function(){})};xit=test.xit;test.xdescribe=function(b,a,c){null==c&&(c="---- TODO");b=""+c+": "+b;console.log(b);return describe(b,function(){return it("",function(){})})};xdescribe=test.xdescribe;
test.conditionalDisablers=function(b,a){var c,d,e,f;null==b&&(b=!0);null==a&&(a="Conditionally Disabled");d=function(c,b){return test.xit(c,b,a)};c=function(c,b){return test.xdescribe(c,b,a)};f=function(c,b){console.log(""+a+": "+c);return it.apply(null,arguments)};e=function(c,b){console.log(""+a+": "+c);return describe.apply(null,arguments)};return b?[d,c]:[f,e]};var derives,util;util=athena.lib.util;util.derives=derives=function(b,a){return!b||!b.__super__?!1:a.prototype===b.__super__?!0:derives(b.__super__.constructor,a)};util.isOrDerives=function(b,a){return b===a||derives(b,a)};util.isStrictObject=function(b){return"[object Object]"===(null!=b?b.toString():void 0)};util.elementInDom=function(b){if(b instanceof $)return _.all(b,util.elementInDom);for(;b=null!=b?b.parentNode:void 0;)if(b===document)return!0;return!1};__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function c(){this.constructor=b}for(var d in a)__hasProp.call(a,d)&&(b[d]=a[d]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b};athena.lib.util.RemoteResource={};athena.lib.util.RemoteResourceInterface={};util=athena.lib.util;
...
a:a};a.prototype.defaults=function(){return{extraClasses:[],eventhub:void 0}};a.prototype.events=function(){return{}};a.prototype.elAttributes=function(){return{}};a.prototype.initialize=function(){var b,d=this;a.__super__.initialize.apply(this,arguments);_.defaults(this.options,this.defaults());this.eventhub=this.options.eventhub||this;if(this.options.extraClasses)return b=this.options.extraClasses,_.isString(b)&&(b=[b]),_.each(b,function(a){return d.$el.addClass(a)})};a.prototype.destroy=function(){this.rendering=
...
b=_.map(b,function(b){return a.data.files[b]});return _.pluck(b,"content").join("\n\n")};return a}(athena.lib.DocView);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function c(){this.constructor=b}for(var d in a)__hasProp.call(a,d)&&(b[d]=a[d]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b};
...
arguments)}__extends(a,b);a.prototype.className=a.classNameExtend("toolbar-view");a.prototype.events=function(){var b=this;return _.extend(a.__super__.events.apply(this,arguments),{"click button:not(.dropdown-toggle)":function(a){a.target.id&&b.trigger("Toolbar:Click:"+a.target.id,b,a);return b.trigger("Toolbar:Click",b,a)},"click .dropdown-toggle":function(a){var e;(e=$(a.target).closest(".btn-group").attr("id"))&&b.trigger("Toolbar:Click:"+e,b,a);return b.trigger("Toolbar:Click",b,a)},"click .dropdown-link":function(a){var e;
e=$(a.target).closest(".btn-group").attr("id");a.target.id&&e&&b.trigger("Toolbar:Click:"+e+":"+a.target.id,b,a);a.target.id&&b.trigger("Toolbar:Click:"+a.target.id,b,a);return b.trigger("Toolbar:Click",b,a)}})};a.prototype.initialize=function(){a.__super__.initialize.apply(this,arguments);return this.buttons=this.options.buttons||[]};a.prototype.button=function(a){var b,e;b=[];e=function(a,c){return _.each(a,function(a){if(_.isArray(a))return e(a,c);if(a.id===c)return b.push(a)})};e(this.buttons,
a);return b.shift()};a.prototype.render=function(){a.__super__.render.apply(this,arguments);this.$el.empty();this.$el.append(this.renderButtonGroup(this.buttons).children());return this};a.prototype.renderButton=function(a){if(a instanceof Backbone.View)return a.render().$el;if(a instanceof $)return a;if(_.isString(a))return this.renderButtonFromObject({text:a});if(_.isArray(a))return this.renderButtonGroup(a);if(_.isObject(a)&&_.isArray(a.dropdown))return this.renderDropdownButtonFromObject(a);if(_.isObject(a))return this.renderButtonFromObject(a)};
a.prototype.renderButtonFromObject=function(a){var b,e,f;b=$("<button>");b.addClass("btn");a.icon&&b.append($("<i class='"+a.icon+"'>"));a.text&&a.icon&&b.append(" ");a.text&&b.append(a.text);a.className&&b.addClass(a.className);a.id&&b.attr("id",a.id);a.tooltip&&(e=a.tooltip,_.isString(e)&&(e={title:a.tooltip}),b.tooltip(e));_.each(null!=(f=a.events)?f:{},function(a,c){return b.on(c,a)});return b};a.prototype.renderDropdownButtonFromObject=function(a){var b,e,f;b=$('<div class="btn-group">');a.className&&
b.addClass(a.className);a.id&&b.attr("id",a.id);f=$('<button class="btn dropdown-toggle" data-toggle="dropdown">');a.icon&&f.append($("<i class='"+a.icon+"'>"));a.text&&a.icon&&f.append(" ");a.text&&f.text(a.text);f.append(" <i class='caret'>");b.append(f);e=$('<ul class="dropdown-menu">');_.each(a.dropdown,function(a){var b;b=$('<a href="#" class="dropdown-link">');a.id&&b.attr("id",a.id);a.leftIcon&&b.append($("<i class='"+a.leftIcon+"'>"));a.text&&b.text(a.text);a.rightIcon&&b.append($("<i class='"+
a.rightIcon+"'>"));return e.append($("<li>").append(b))});b.append(e);return b};a.prototype.renderButtonGroup=function(a){var b,e=this;b=$("<div>");b.addClass("btn-group");_.each(a,function(a){var c;return null!=(c=e.renderButton(a))?c.appendTo(b):void 0});return b};return a}(athena.lib.View);__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function c(){this.constructor=b}for(var d in a)__hasProp.call(a,d)&&(b[d]=a[d]);c.prototype=a.prototype;b.prototype=new c;b.__super__=a.prototype;return b};
