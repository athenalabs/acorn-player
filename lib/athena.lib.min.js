...
athena.lib.Model=function(b){function a(){this.toJSONString=__bind(this.toJSONString,this);this.toJSON=__bind(this.toJSON,this);this.clone=__bind(this.clone,this);this.properties=__bind(this.properties,this);this.property=__bind(this.property,this);this.initialize=__bind(this.initialize,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.initialize=function(){a.__super__.initialize.apply(this,arguments);return this.properties(_.keys(this.attributes))};a.prototype.property=
function(a){var b=this;if(null==a)throw Error("Expected `property` parameter to be defined.");if(!_.isString(a))throw Error("Expected `property` to be of type string.");return this[a]=function(e){null!=e&&b.set(a,e);return b.get(a)}};a.prototype.properties=function(a){var b=this;if(null==a)throw Error("Expected `propertyArray` parameter to be defined.");if(!_.isArray(a))throw Error("Expected `propertyArray` parameter to be of type Array.");return _.each(a,function(a){return b.property(a)})};a.prototype.clone=
function(){return new this.constructor(this.toJSON())};a.prototype.toJSON=function(){return JSON.parse(JSON.stringify(this.attributes))};a.prototype.toJSONString=function(){return JSON.stringify(this.toJSON())};return a}(Backbone.Model);athena.lib.util={};
