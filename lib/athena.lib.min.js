...
it("should have an elAttributes function, that returns an object",function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(d);return expect(typeof a.events()).toBe("object")});it("should have render return @",function(){var a;a=new b(d);return expect(a.render()).toBe(a)});return"function"===typeof c?c():void 0})};
test.describeDefaults=function(b,a,d){null==d&&(d={});return describe(""+b.name+"::defaults",function(){var c;c=(new b(d)).defaults();return _.each(a,function(a,b){return it("should have options."+b+" default to "+JSON.stringify(a),function(){return expect(c[b]).toEqual(a)})})})};
...
return b}();__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
...
a.prototype.renderButtonFromObject=function(a){var b,e,f;b=$("<button>");b.addClass("btn");a.icon&&b.append($("<i class='"+a.icon+"'>"));a.text&&b.append(a.text);a.className&&b.addClass(a.className);a.id&&b.attr("id",a.id);a.tooltip&&(e=a.tooltip,_.isString(e)&&(e={title:a.tooltip}),b.tooltip(e));_.each(null!=(f=a.events)?f:{},function(a,d){return b.on(d,a)});return b};a.prototype.renderButtonGroup=function(a){var b,e=this;b=$("<div>");b.addClass("btn-group");_.each(a,function(a){var d;return null!=
(d=e.renderButton(a))?d.appendTo(b):void 0});return b};return a}(athena.lib.View);("undefined"!==typeof exports&&null!==exports?exports:this).athena=athena;}).call(this);
