...
it("should have an elAttributes function, that returns an object",function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(d);return expect(typeof a.events()).toBe("object")});it("should have render return @",function(){var a;a=new b(d);return expect(a.render()).toBe(a)});it("should be rendering after render (i.e. should call super)",function(){var a;a=new b(d);expect(a.rendering).toBe(!1);a.render();return expect(a.rendering).toBe(!0)});return"function"===typeof c?c():void 0})};
