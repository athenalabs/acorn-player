...
athena.lib.Model=function(b){function a(){this.toJSONString=__bind(this.toJSONString,this);this.toJSON=__bind(this.toJSON,this);this.clone=__bind(this.clone,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.property=function(a,b){null==b&&(b=!0);return function(e){b&&null!=e&&this.set(a,e);return this.get(a)}};a.prototype.clone=function(){return new this.constructor(this.toJSON())};a.prototype.toJSON=function(){return JSON.parse(JSON.stringify(this.attributes))};a.prototype.toJSONString=
...
athena.lib.Router=function(b){function a(){this.navigateBrowser=__bind(this.navigateBrowser,this);this.go=__bind(this.go,this);this.initialize=__bind(this.initialize,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.initialize=function(b){var c,e=this;a.__super__.initialize.apply(this,arguments);this.options=null!=b?b:{};this.eventhub=null!=(c=this.options.eventhub)?c:this;this.app=this.options.app;return this.eventhub.on("Go",function(a){return e.go(a)})};a.prototype.go=
function(a){if(null==a)throw Error("Router::go requires a `url` parameter");if(a.match(/^(https?:)?\/\//i))this.navigateBrowser(a);else return this.navigate(a,{trigger:!0})};a.prototype.navigateBrowser=function(a){return window.location.href=a};return a}(Backbone.Router);athena.lib.util={};
