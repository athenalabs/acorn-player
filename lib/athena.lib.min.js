...
e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.identify(a));return h};a.prototype.track=function(a,b,e){var f,g,h,k,l;k=this.trackers;l=[];g=0;for(h=k.length;g<h;g++)f=k[g],l.push(f.track(a,b,e));return l};a.prototype.register=function(a){var b,e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.register(a));return h};a.prototype.unregister=function(a){var b,e,f,g,h;g=this.trackers;h=[];e=0;for(f=g.length;e<f;e++)b=g[e],h.push(b.unregister(a));return h};
...
return expect(c[a]()).toEqual("foo")});!1===d.setter?it("should NOT set the value of the attribute (setter is false)",function(){var c,h,g,j;c=new b(f);expect(c[a]()).toEqual(null!=(h=d["default"])?h:c.get(e));expect(c[a]()).not.toEqual("foo");expect(c[a]("foo")).toEqual(null!=(g=d["default"])?g:c.get(e));expect(c[a]()).toEqual(null!=(j=d["default"])?j:c.get(e));return expect(c[a]()).not.toEqual("foo")}):it("should set the value of the attribute",function(){var c,h;c=new b(f);expect(c[a]()).not.toEqual("foo");
