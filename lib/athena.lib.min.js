...
arguments);return this.addProperties(this.properties())};a.prototype.addProperty=function(a,b){var e=this;if(null==a)throw Error("Expected `property` parameter to be defined.");if(!_.isString(a))throw Error("Expected `property` to be of type string.");this[a]=function(b){null!=b&&e.set(a,b);return e.get(a)};if(null!=b&&null==this[a]())return this[a](b)};a.prototype.addProperties=function(a){var b=this;if(null==a)throw Error("Expected `properties` parameter to be defined.");if(!_.isObject(a))throw Error("Expected `properties` parameter to be of type Array.");
return _.each(a,function(a,c){return b.addProperty(c,a)})};a.prototype.clone=function(){return new this.constructor(this.toJSON())};a.prototype.toJSON=function(){return JSON.parse(JSON.stringify(this.attributes))};a.prototype.toJSONString=function(){return JSON.stringify(this.toJSON())};return a}(Backbone.Model);athena.lib.util={};
