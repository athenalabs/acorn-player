...
athena.lib.Model=function(b){function a(){this.toJSONString=__bind(this.toJSONString,this);this.toJSON=__bind(this.toJSON,this);this.clone=__bind(this.clone,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.prototype.clone=function(){return new this.constructor(this.toJSON())};a.prototype.toJSON=function(){return JSON.parse(JSON.stringify(this.attributes))};a.prototype.toJSONString=function(){return JSON.stringify(this.toJSON())};return a}(Backbone.Model);athena.lib.util={};
