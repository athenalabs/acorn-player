...
test.describeSubview=function(b,a){var c,d,e,f,g;d=b.View;g=b.viewOptions;f=b.subviewAttr;c=b.Subview;e=b.checkDOM;null==e&&(e=function(a,b){return a.parentNode===b});return describe(""+d.name+"::"+f+" subview",function(){it("should be defined on init",function(){var a;a=new d(g);return expect(a[f]).toBeDefined()});it("should be an instanceof "+c.name,function(){var a;a=new d(g);return expect(a[f]instanceof c)});it("should not be rendering initially",function(){var a;a=new d(g);return expect(a[f].rendering).toBe(!1)});
