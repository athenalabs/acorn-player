...
b.prototype.callsSinceLastCheck=function(){var a;a=this._callsSinceLastCheck;this._callsSinceLastCheck=0;return a};return b}();test.expectEventSpyBehaviors=function(b,a){var d,c,e,f,g,h,j,k,m,l,n;n=[];k=0;for(m=a.length;k<m;k++)g=a[k],e=null!=(l=g())?l:{},n.push(function(){var a;a=[];for(j in b)h=b[j],f=e.hasOwnProperty(j),c=h.callsSinceLastCheck(),expect(!!c).toBe(f),f&&null!=(d=e[j])?(_.isArray(d)||(d=[d]),a.push(expect(_.last(h.arguments)).toEqual(d))):a.push(void 0);return a}());return n};
...
arguments),{trigger:"click",delay:{show:300,hide:100}})};a.prototype.render=function(){a.__super__.render.apply(this,arguments);this.showing=!1;this.popover({animation:this.options.animation,placement:this.options.placement,trigger:this.options.trigger,title:this.options.title,delay:this.options.delay,content:this});return this};a.prototype.popover=function(a){$(this.options.popover).popover(a);return this};a.prototype.show=function(){if(this.rendering)return this.popover("show"),this.showing=!0,
this.trigger("PopoverView:PopoverDidShow")};a.prototype.hide=function(){if(this.rendering)return this.popover("hide"),this.showing=!1,this.trigger("PopoverView:PopoverDidHide")};a.prototype.toggle=function(){if(this.rendering)return this.showing?this.popover("hide"):this.popover("show"),this.showing=!this.showing,this.trigger("PopoverView:PopoverDid"+(this.showing?"Show":"Hide"))};a.prototype.destroy=function(){$(this.options.popover).popover("destroy");return a.__super__.destroy.apply(this,arguments)};
return a}(athena.lib.ContainerView);console.log("patching Popover");Popover=$.fn.popover.Constructor;Popover.prototype._setContent=Popover.prototype.setContent;
