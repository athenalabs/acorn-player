...
it("should have an elAttributes function, that returns an object",function(){var a;expect(typeof b.prototype.elAttributes).toBe("function");a=new b(d);return expect(typeof a.elAttributes()).toBe("object")});it("should set @eventhub in initialize (i.e. should call super)",function(){var a,c;a=_.extend({},Backbone.Events);c=_.defaults({eventhub:a},d);c=new b(c);return expect(c.eventhub).toBe(a)});it("should have render return @",function(){var a;a=new b(d);return expect(a.render()).toBe(a)});it("should be rendering after render (i.e. should call super)",
