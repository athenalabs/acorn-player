...
athena.lib.Model=function(b){function a(){this.toJSONString=__bind(this.toJSONString,this);this.toJSON=__bind(this.toJSON,this);this.clone=__bind(this.clone,this);return a.__super__.constructor.apply(this,arguments)}__extends(a,b);a.property=function(a,b){null==b&&(b={});return function(e){var f;!1!==b.setter&&null!=e&&this.set(a,e);return null!=(f=this.get(a))?f:b["default"]}};a.prototype.clone=function(){return new this.constructor(this.toJSON())};a.prototype.toJSON=function(){return JSON.parse(JSON.stringify(this.attributes))};
...
it("should have an elAttributes function, that returns an object",function(){var a;expect(typeof b.prototype.events).toBe("function");a=new b(d);return expect(typeof a.events()).toBe("object")});it("should have render return @",function(){var a;a=new b(d);return expect(a.render()).toBe(a)});return typeof c==="function"?c():void 0})};
...
function(a){return this.view.content(a)};b.prototype.start=function(){return Backbone.history.start({pushState:!0})};return b}();__bind=function(b,a){return function(){return b.apply(a,arguments)}};__hasProp={}.hasOwnProperty;__extends=function(b,a){function d(){this.constructor=b}for(var c in a)__hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b};
